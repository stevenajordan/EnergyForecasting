---
title: "K12_Analysis Compounded Daily"
...
df = read.csv('C:/Users/sajor/Documents/Career/Class/Capstone/Daily Aggregated Files/consump_agg_sectors/consump_k12_daily_agg.csv')
...
plot(df$Electricity_KW_AVG, type = "l", main="K12 Electricity Consumption",
...
plot(df$Electricity_KW_HR_log, type = "l", main="K12 Electricity Consumption",
     xlab="Day", ylab = "Mean KW/HR")
